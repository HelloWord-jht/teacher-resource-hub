...
public class ImportTask {
    ...
    private String recommendedTagIdsJson;
    ...
    public String getRecommendedTagIdsJson() { return recommendedTagIdsJson; }
    public void setRecommendedTagIdsJson(String recommendedTagIdsJson) { this.recommendedTagIdsJson = recommendedTagIdsJson; }
